            ...
            <li>
              <Link href="https://www.linkedin.com/in/fabrice-sapienza-8934a5129">
                <a aria-label="Page Linkedin Fabrice Sapienza">
                  <FaLinkedin className="cursor-pointer text-2xl text-secondary transition-all duration-200 hover:text-primary mr-3" />
                </a>
              </Link>
            </li>
            <li>
              <Link href="https://github.com/Fabrice-Sapienza">
                <a aria-label="Page GitHub Fabrice Sapienza">
                  <FaGithub className="cursor-pointer text-2xl text-secondary transition-all duration-200 hover:text-primary mr-3" />
                </a>
              </Link>
            </li>
          </ul>
